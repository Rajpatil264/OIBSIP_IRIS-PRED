...
def main():
    # Information Section
    st.markdown(
        "<h1 style='text-align: center;'>Iris Information</h1>", unsafe_allow_html=True
    )
    st.image(
        "IRISIMAGE.jpg",
        use_column_width=True,
        caption="Image source: Your Source Here",
    )
    st.write(
        "Welcome to the Iris Flower Species Classifier app! This application utilizes a Random Forest model to categorize Iris flowers into three distinct species: Setosa, Versicolor, and Virginica. The dataset employed here comprises four fundamental features: sepal length, sepal width, petal length, and petal width."
    )
    st.write(
        "The Iris dataset holds significant prominence within the realms of machine learning and statistics. Originating in 1936, it was introduced by the eminent British statistician and biologist, Ronald A. Fisher. This dataset encompasses a total of 150 samples of Iris flowers, partitioned equally into three distinct species categories:"
    )
    st.write("- Setosa (0)")
